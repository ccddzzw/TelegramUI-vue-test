<template>
  <svg id="s151:1947" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" v-bind="$attrs">
    <g transform="matrix(1,0,0,1,0,0)">
      <g id="s151:1947" opacity="1" style="mix-blend-mode: normal">
        <g>
          ...
          <g clip-path="url(#151:1947_clipPath)">
                ...
                <g>
                  <g>
                    <path id="s151:1985_fill_path"
                      ...
                      fill-rule="nonzero" fill="currentColor" fill-opacity="1"
